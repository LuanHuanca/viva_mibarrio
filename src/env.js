...
export const env = createEnv({
  server: {
    ...
    AD_MIN_SECONDS: z.coerce.number().default(10),
    WHATSAPP_ASISTENTE_PHONE: z.string().optional(),
  ...
  client: {
    ...
    NEXT_PUBLIC_AD_MIN_SECONDS: z.coerce.number().default(10),
  ...
  runtimeEnv: {
    ...
    WHATSAPP_ASISTENTE_PHONE: process.env.WHATSAPP_ASISTENTE_PHONE,
